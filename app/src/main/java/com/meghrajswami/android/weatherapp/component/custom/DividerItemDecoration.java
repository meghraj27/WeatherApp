...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecoration(Context context, int orientation, int dividerPaddingLeft, int dividerPaddingRight) {
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        final int left = parent.getPaddingLeft() + dividerPaddingLeft;
        final int right = parent.getWidth() - dividerPaddingRight - parent.getPaddingRight();
